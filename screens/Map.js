...
export default function Map(props) {
    ...
    const [shuttlePressed, setShuttlePressed] = useState(false);
    const [bus503Pressed, setBus503Pressed] = useState(false);
    return (
        <FUNowMapView>
            <ModifiedPolyline
                ...
                lineJoin={"round"}
                tappable={true}
                onPress={() => { console.log("pressed-503", bus503Pressed); setBus503Pressed(!bus503Pressed)}}
            />
            <ModifiedPolyline
                ...
                strokeWidth={9}
                lineJoin={"round"}
                onPress={() => setShuttlePressed(true)}
            />
            <BusStopMarker color={"#582C83"} 
